        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1 text-center md:text-left order-2 md:order-1">
            ...
            <p className="text-lg mp-4">
              ...
              contagiante, sempre buscando fazer as pessoas ao meu redor se
              sentirem bem. Estou em constante busca por aprimorar minhas
              habilidades em áreas de meu interesse e tecnologia em geral
            </p>
          </div>
